...
export default function Home() {
  ...
  return <main className="site">
    <header className="header"><nav className="nav" aria-label="Primary navigation"><a className="logo" href={`${basePath}/`} aria-label="TrendForge home">Trend<span>Forge</span></a><div className="links"><a href="#latest">Latest</a><a href="#topics">Topics</a><a href={`${basePath}/about/`}>About</a><a className="nav-subscribe" href={`${basePath}/subscribe/`}>Subscribe</a></div></nav></header>
