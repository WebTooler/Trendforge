...
const pack={version:1,status:'authoritative',generatedAt:new Date().toISOString(),candidate:{title:'Repair fixture',link:'https://example.com/story',category:'Technology'},policy:'test',sources:[{id:'S1',url:'https://example.com/source',finalUrl:'https://example.com/source',domain:'example.com',publisherFamily:'example.com',title:'Example source',verified:true,primary:true,credibilityTier:'9',lineage:{id:'example-lineage',type:'original',members:1},passages:['Supported fact passage.'],body:'Full canonical publisher body.',extraction:null}],coverage:{},blueprint:{mode:'usable'}};
