...
const ATTRIBUTION_MARKERS=/\b(?:according to|said|says|reported|reports|announced|told|argued|noted|acknowledged|found|the report|the study|the lawsuit|the complaint|the filing|the announcement|the request|officials?)\b/i;
