const UNCERTAINTY_MARKERS=/\b(?:may|might|could|possible|possibly|potentially|expected|expects|likely|unlikely|appears|appeared|reportedly|reportedly|according to|said|says|reported|alleged|allegedly|projected|forecast|estimated|suggests|suggested)\b/i;
