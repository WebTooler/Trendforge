...
console.log('Policy: lab-only, no AI generation, no publication, main branch untouched.');
...
fs.writeFileSync(OUTPUT,JSON.stringify({
  ...
  policy:'All pre-writer gates run in lab only. No AI generation, no publication, no main-branch changes.',
  stages:[
...
console.log('\nPre-Writer pipeline completed. Generate Article was NOT executed.');
