...
export function assessArticleDepth({content='',blueprint=null}={}){
  ...
  const rules={rich:{minWords:650,minH2:0,minSectionWords:70,minSubstantiveParagraphs:5,minSentences:12},bounded:{minWords:425,minH2:0,minSectionWords:60,minSubstantiveParagraphs:4,minSentences:10},narrow:{minWords:300,minH2:0,minSectionWords:50,minSubstantiveParagraphs:3,minSentences:8},default:{minWords:300,minH2:0,minSectionWords:50,minSubstantiveParagraphs:3,minSentences:8}}[mode]||{minWords:300,minH2:0,minSectionWords:50,minSubstantiveParagraphs:3,minSentences:8};
