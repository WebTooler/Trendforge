...
assert.equal(assessHumanization('Company update changes the interface. Company update adds a search filter. Company update also changes the settings page.').blocked,true);
