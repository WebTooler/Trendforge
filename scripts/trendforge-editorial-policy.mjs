...
export function validateDraft({title='',description='',content='',category='Technology',blueprint=null}){
 ...
 if(blueprint?.maxH2>0&&h2>Number(blueprint.maxH2))errors.push(`H2 count ${h2} exceeds evidence-derived maximum ${blueprint.maxH2}`);if(duplicateSentence)errors.push('consecutive duplicate sentence detected');if(repeatedSentence)errors.push('repeated factual sentence detected across article');if(repeatedParagraph)errors.push('repetitive paragraph/topic overlap detected across article');
