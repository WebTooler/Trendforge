...
export function validateDraft({title='',description='',content='',category='Technology',blueprint=null}){
 ...
 // H2 count is advisory. Structural quality is enforced through substantive sections, repetition, depth, and evidence coverage rather than a numeric ceiling.if(duplicateSentence)errors.push('consecutive duplicate sentence detected');if(repeatedSentence)errors.push('repeated factual sentence detected across article');if(repeatedParagraph)errors.push('repetitive paragraph/topic overlap detected across article');
