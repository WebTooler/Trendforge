...
export function validateDraft({title='',description='',content='',category='Technology',blueprint=null}){
 ...
 const blueprintMax=Number(blueprint?.maxH2||0); if(blueprintMax>0&&h2>blueprintMax)errors.push(`H2 count ${h2} exceeds evidence blueprint maximum ${blueprintMax}`);if(duplicateSentence)errors.push('consecutive duplicate sentence detected');if(repeatedSentence)errors.push('repeated factual sentence detected across article');if(repeatedParagraph)errors.push('repetitive paragraph/topic overlap detected across article');
