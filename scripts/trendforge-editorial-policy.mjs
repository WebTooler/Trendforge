...
export function validateDraft({title='',description='',content='',category='Technology',blueprint=null}){
 ...
 const shallowSections=h2Sections(content).filter(section=>sectionWordCount(section)<35&&sectionSentenceCount(section)<2).length;
